...
Thursday        1–5 pm', 
    '["outdoor activities", "group activities", "adventure activities"]'::jsonb, 
...
Sunday	10 am–10 pm
', 
    '["indoor activities", "group activities", "adventure activities", "kids activities"]'::jsonb, 
...
Saturday        10 am–10 pm
Sunday        10 am–10 pm', 
    '["outdoor activities", "leisure activities"]'::jsonb, 
...
Sunday	5:30 am–12 pm, 4–9 pm', 
    '["outdoor activities", "unique cultural experiences", "leisure activities"]'::jsonb, 
    NULL, 
    'free', 
    NULL, 
    'chennai', 
...
', 
    '["outdoor activities", "adventure activities", "group activities", "kids activities"]'::jsonb, 
...
', 
    '["outdoor activities", "group activities", "sports activities"]'::jsonb, 
...
INSERT INTO activities (
    ...
    NULL, 
    '["indoor activities", "group activities", "sports activities"]'::jsonb, 
...
Sunday        11 am–10 pm', 
    '["unique cultural experiences", "leisure activities"]'::jsonb, 
    NULL, 
    'paid', 
    'Rs 500', 
    'chennai', 
...
Sunday 7 am–10 am, 3 pm–5 pm, 8 pm–10 pm', 
    '["unique cultural experiences", "leisure activities", "low budget fun activities"]'::jsonb, 
...
Sunday	11 am–10 pm', 
    '["indoor activities", "gaming activities", "low budget fun activities"]'::jsonb, 
    NULL, 
    'paid', 
    'Rs 150 per game', 
    'chennai', 
...
Saturday	10 am–10 pm
Sunday	10 am–10 pm', 
    '["indoor activities", "group activities", "leisure activities"]'::jsonb, 
    NULL, 
    'paid', 
...
Sunday	10:30 am–10:30 pm', 
    '["indoor activities", "group activities", "leisure activities", "gaming activities"]'::jsonb, 
    NULL, 
    'paid', 
    'Rs 350 per person', 
    'chennai', 
...
Saturday	10:30 am–10 pm
Sunday	10:30 am–10 pm', 
    '["indoor activities", "group activities", "gaming activities"]'::jsonb, 
    NULL, 
    'paid', 
...
Sunday	11 am–10 pm
', 
    '["indoor activities", "gaming activities"]'::jsonb, 
    NULL, 
    'paid', 
    NULL, 
    'chennai', 
